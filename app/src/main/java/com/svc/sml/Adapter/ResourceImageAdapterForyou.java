 ...
 * 
 */
public class ResourceImageAdapterForyou extends AbstractCoverFlowImageAdapter2 {

    /** The Constant TAG. */
    private static final String LOGTAG = ResourceImageAdapterForyou.class.getSimpleName();
   ...
   // private static final int[] DEFAULT_RESOURCE_LIST = {R.drawable.image06,R.drawable.image07,R.drawable.image08,R.drawable.image09,R.drawable.image10,R.drawable.image11 };
     ...
     *            context
     */
    public ResourceImageAdapterForyou(final Context context) {
        super();
...
//    }
    public ResourceImageAdapterForyou(final Context context, String looksCategoryTitle , ArrayList<ComboData> comboList) {
