 ...
 * adapter.
 */
public abstract class AbstractCoverFlowImageAdapter2 extends AbstractCoverFlowImageAdapter {

    private final static String LOGTAG = AbstractCoverFlowImageAdapter2.class.getSimpleName();
    ...
    public AbstractCoverFlowImageAdapter2() {
        super();
    }

    public AbstractCoverFlowImageAdapter2(final Context context, String looksCategoryTitle, ArrayList<ComboData> comboList) {
        super();
        this.comboList = comboList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            if (inflater == null)
                inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.list_item_combo_gallery_foryou, parent, false);
            holder = new Holder();
